...
export default {
  ...
  data () {
    return {
      slides: [
        {
          head: 'SA Dualshot Keycap Set',
          desc: 'Лимитированое издание даблшот кейкапов SA профиля',
          image: require('@/assets/images/Slider/SADualshotSet.png')
        },
        {
          head: 'SA Dualshot Keycap Set',
          desc: 'Лимитированое издание даблшот кейкапов SA профиля',
          image: require('@/assets/images/Slider/Keyboard.png')
        },
        {
          head: 'SA Dualshot Keycap Set',
          desc: 'Лимитированое издание даблшот кейкапов SA профиля',
          image: require('@/assets/images/Slider/RedDragon.png')
        }
      ],
      settings: {
        arrows: true,
